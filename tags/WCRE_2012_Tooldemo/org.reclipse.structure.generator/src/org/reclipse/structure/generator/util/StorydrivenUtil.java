...
public final class StorydrivenUtil
{
	...
	{
		Expression expression = ExpressionsUtil.createTextualExpression(expressionText);
	...
	{
		ParameterExpression expression = ExpressionsUtil.createParameterExpression(forwarded);
	...
	public static Constraint addSetResultsExpression(PSPatternSpecification pattern, StoryNode storyNode)
	{
		...
		Expression expression = ExpressionsUtil.createTextualExpression(name + "=true"); //$NON-NLS-1$
